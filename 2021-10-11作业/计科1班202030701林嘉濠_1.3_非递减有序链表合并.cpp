 ...
 * @LastEditTime: 2021-10-11 19:45:22
 * @FilePath: \2021-10-11作业\计科1班202030701林嘉濠_1.3_非递减有序链表合并.cpp
 */
...
Status MergeList_Sq(Sqlist &La, Sqlist &Lb, Sqlist &Lc)
{
    ...
    //3. 将剩下元素全部插入到Lc
    while (pa <= pa_last) *pc++ = *pa++;    //a还有元素，b已经取完
...
int main()
{
    ...
    cout << "创建一个4个元素的链表:" << endl;
    CreateList_Up(La,4); //创建非递减链表 
    cout<<"Show La:"<<endl;
    Show(La); //遍历线性表 
    cout << "创建一个7个元素的链表:" << endl;
    CreateList_Up(Lb,7);
    cout<<"Show Lb:"<<endl;
    Show(Lb);
